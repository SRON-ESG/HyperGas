...
``radiance_2100``, ``rgb``, ``sp``, ``u10``, and ``v10``.
    ...
    - ``rgb``:  An RGB image generated by HyperGas using the `HSI2RGB <https://github.com/JakobSig/HSI2RGB>`_ method applied to HSI L1 data. If this method fails, bands near 650, 560, and 470 nm are combined with Gamma normalization.
