...
def reprocess_data(filename, prefix, species, land_mask_source, skip_water, skip_cloud, rad_dist, unortho_export):
    ...
    l2b_scene.retrieve(plume_mask=mask_resample, land_mask_source=land_mask_source, skip_water=skip_water, skip_cloud=skip_cloud, rad_dist=rad_dist)
    ...
    if unortho_export:
        ...
        l2b_scene.hyp.scene.save_datasets(
            datasets=[species, f'{species}_comb', 'quality_mask', 'segmentation'], filename=unortho_savename, writer='cf')
...
def main():
    ...
    for file_plume0 in filelist:
        ...
        reprocess_data(filenames[0], prefix, species, land_mask_source, skip_water, skip_cloud, rad_dist, unortho_export)
